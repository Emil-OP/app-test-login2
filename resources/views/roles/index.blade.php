...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        @can('role-create')
            <a class="btn btn-success btn-sm mb-2" href="{{ route('roles.create') }}"><i class="fa fa-plus"></i> Crear Nuevo Role</a>
            @endcan
        </div>
    </div>
</div>
...
<p class="text-center text-primary"><small>Gestión de Roles</small></p>
@endsection
